...
//@		traceLoggable = logger.isLoggable(Level.TRACE);
    ...
    BaseApp.cOK = BaseApp.newCommand(AppConstants.MSG_LABEL_OK, Command.OK, 30);
    BaseApp.cBACK = BaseApp.newCommand(AppConstants.MSG_BACK, Command.BACK, 20, BaseApp.AC_BACK);
    BaseApp.cEXIT = BaseApp.newCommand(AppConstants.MSG_EXIT, Command.EXIT, 10, BaseApp.AC_EXIT);
    ...
    BaseApp.menu = new short[][] {
        {
            SecureSMS.ME_MAINMENU, AppConstants.MSG_INBOX, SecureSMS.AC_SHOWINBOX, -1
        }, {
            SecureSMS.ME_MAINMENU, AppConstants.MSG_SENDNEW, SecureSMS.AC_SHOWSENDNEW, -1
        }, {
            SecureSMS.ME_MAINMENU, AppConstants.MSG_SENTITEMS, SecureSMS.AC_SHOWSENTITEMS, -1
        }, {
            SecureSMS.ME_MAINMENU, AppConstants.MSG_ADDRESSBOOK, SecureSMS.AC_SHOWADDRESSBOOK, -1
        }, {
            SecureSMS.ME_MAINMENU, AppConstants.MSG_CHANGEPIN, SecureSMS.AC_SHOWPINCHANGE, -1
        }, {
            SecureSMS.ME_MAINMENU, AppConstants.MSG_CLEANUP, SecureSMS.AC_CLEANUP, -1
        }, {
            SecureSMS.ME_MAINMENU, AppConstants.MSG_MENU_MAIN_ABOUT, SecureSMS.AC_SHOWABOUT, -1
        }, {
            SecureSMS.ME_CLEANUP, AppConstants.MSG_CLEANUP1, SecureSMS.AC_CLEANUP1, -1
        }, {
            SecureSMS.ME_CLEANUP, AppConstants.MSG_CLEANUP2, SecureSMS.AC_CLEANUP2, -1
        }, {
            SecureSMS.ME_CLEANUP, AppConstants.MSG_CLEANUP3, SecureSMS.AC_CLEANUP3, -1
        }
    };
    Settings.load();
  }
  ...
  public void init() {
    ...
    try {
      ...
      scMenu = Application.getMenu(BaseApp.messages[AppConstants.MSG_SECUREMESSENGER], SecureSMS.ME_MAINMENU, -1, BaseApp.cEXIT);
    ...
    try {
      ...
      switch (action) {
        ...
        case AC_SHOWADDRESSBOOK:
          ...
          break;
        case AC_SHOWABOUT:
          BaseApp.show(null, BaseApp.getTextForm(AppConstants.MSG_MENUABOUT, "about.txt"), true);
          break;
        case AC_SENDNEW:
